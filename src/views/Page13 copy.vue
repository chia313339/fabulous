<template>
    <div class="fullwidthbanner-container">
      <div class="tag-box">
        <div class="tag">
          <b>人文之雅 &nbsp;&nbsp; | &nbsp;&nbsp; 
            <span @click="goToSlide(0)">生機圖 / </span>&nbsp;
            <span @click="goToSlide(1)">交通圖 / </span>&nbsp;
            <span @click="goToSlide(2)">商圈 / </span>&nbsp;
            <span @click="goToSlide(3)">學區 / </span>
          </b>
        </div>
      </div>
  ...
  setup() {
    ...
    const goToSlide = (index) => {
      if (carouselRef.value) {
        ...
        showOverlayImages.value = index === 3;
      }
