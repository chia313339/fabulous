<template>
  <div class="fullwidthbanner-container">
    <div class="tag-box">
      <div class="tag">
        <b>將捷集團 &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp; <span>將捷建設</span></b>
      </div>
    </div>
    <router-link to="/page20" class="back-arrow">
    ...
    <div class="content">
      <img src="/img/p21/bg.png" alt="" class="bg">
      <div class="overlay">
        <div class="left">
        ...
        <div class="right">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/img/p21/001.png" class="d-block w-100" alt="...">
              <div class="carousel-caption">
                <p>將捷之琚</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p21/002.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <p>將捷國際商業大樓</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p21/003.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <p>將捷之森</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p21/004.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <p>將捷巴菲特</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p21/005.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <p>將捷旅闊</p>
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p21/006.png" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <p>將捷央旅</p>
              </div>
            </div>
