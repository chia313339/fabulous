<template>
  <div class="fullwidthbanner-container">
    ...
    <div class="content">
      <img src="/img/p33/bg.png" alt="" class="bg">
      <div class="overlay">
        <div class="left">
        ...
        <div class="right">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/img/p33/001.png" class="d-block w-100" alt="...">
              <div class="carousel-caption">
                <!-- <p>將捷之琚</p> -->
              </div>
            </div>
            <div class="carousel-item">
              <img src="/img/p33/002.png" class="d-block w-100" alt="...">
