      ...
      <div id="carouselExample" class="carousel slide content d-flex align-items-center justify-content-center" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/img/p14/001.png" class="d-block w-100 carousel-img" alt="圖片1">
          </div>
          <div class="carousel-item">
            <img src="/img/p14/002.png" class="d-block w-100 carousel-img" alt="圖片2">
          </div>
          <div class="carousel-item">
            <img src="/img/p14/003.png" class="d-block w-100 carousel-img" alt="圖片3">
          </div>
        </div>
