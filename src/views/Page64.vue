    ...
    <div id="carouselExample" class="carousel slide content d-flex align-items-center justify-content-center" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/img/p64/001.png" class="d-block w-100 carousel-img" alt="十大優勢及個案比較 1">
        </div>
        <div class="carousel-item">
          <img src="/img/p64/002.png" class="d-block w-100 carousel-img" alt="十大優勢及個案比較 2">
        </div>
        <div class="carousel-item">
          <img src="/img/p64/003.png" class="d-block w-100 carousel-img" alt="十大優勢及個案比較 3">
        </div>
      </div>
